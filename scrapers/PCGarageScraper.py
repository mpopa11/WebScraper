...
def extract_parameters(product_description):
    ...
    start_index = product_description.find("Laptop ") + len("Laptop ")
...
def scrape():
    ...
    file = open('PCGarage_database.csv', 'w', newline='', encoding='utf-8')
    file.close()
    ...
    for i in range(2, 93):
        ...
        driver.get(f"https://www.pcgarage.ro/notebook-laptop/pagina{i}/")
